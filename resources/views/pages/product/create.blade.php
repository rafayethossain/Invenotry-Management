		...
		<div class="col-sm-8">
			<form action="/product" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group{{ $errors->has('product_code') ? ' has-error' : '' }}">
					...
					<input type="text" class="form-control" id="product_code" name="product_code" value="{{ old('product_code') }}" placeholder=" Product Code">
				...
				<div class="form-group{{ $errors->has('mrp') ? ' has-error' : '' }}">
					...
					<input type="number" step="any" min="0" class="form-control" id="mrp" name="mrp" value="{{ old('mrp') }}" placeholder=" Product MRP">
					@if ($errors->has('mrp'))
					<span class="help-block">
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="product_details" name="product_details" placeholder="Product Details" rows="3" cols="50">{{ old('product_details') }}</textarea>
				</div>
