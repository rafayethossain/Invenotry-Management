...
<br>
<div class="container">
	<h2 style="text-align: center;">Create a New Sub Category</h2>
	<hr>
	<div class="row">
		...
		<div class="col-sm-8">
			<form action="/subcategory" method="POST">
				...
				<div class="form-group{{ $errors->has('subCategory_name') ? ' has-error' : '' }}">
					...
					<input type="text" class="form-control" id="subCategory_name" name="subCategory_name" value="{{ old('subCategory_name') }}" placeholder="Category Name">
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="subCategory_details" name="subCategory_details" placeholder="Category Details" rows="5" cols="50">{{ old('subCategory_details') }}</textarea>
				</div>
