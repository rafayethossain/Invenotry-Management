...
<div class="content-header">
	...
	<form id="particularexpense" method="GET" action="{{url('purchase/report')}}" class="form-inline">
		...
		<input type="text" name="start_date" id="start_date" class="form-control" placeholder="Start Date" value="{{$start_date}}">
		<label for="inlineFormCustomSelect">End Date</label>
		<input type="text" name="end_date" id="end_date" class="form-control" placeholder="End Date" value="{{$end_date}}">
...
@endif
<div class="container">
	<h2 style="text-align: center;">Purchases List From {{$start_date}} To {{$end_date}}</h2>
	<hr>
	<div class="col-md-12">
		<table id="myTable">
			<thead>
