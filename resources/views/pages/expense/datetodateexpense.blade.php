...
<div class="content-header">
	...
	<form id="particularexpense" method="GET" action="{{ url('print-expense-report') }}" class="form-inline">
		{{ csrf_field() }}
...
<div id="approval"></div>
<div class="container">
	<h2 style="text-align: center;">Expenses List From {{$start_date}} To {{$end_date}}</h2>
	<hr>
	<div class="col-md-12">
		<table id="myTable">
			<thead>
