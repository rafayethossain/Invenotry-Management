...
@section('title', 'Particular Item Expense Report')
...
<div class="content-header">
	...
	<form id="particularexpense" method="GET" action="{{ url('print-particular-expense-report') }}" class="form-inline">
		{{ csrf_field() }}
		<input type="hidden" name="expense_type" id="expense_type" class="form-control" required="required" value="{{$expenseItem->id}}">
